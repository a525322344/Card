...
public class TransformEditor : Editor
{
    public void DrawABetterInspector(Transform t)
    {
        ...
        Vector3 position = Vector3Field("Position", t.localPosition);
        Vector3 eulerAngles = Vector3Field("Rotation", t.localEulerAngles);
        Vector3 scale = Vector3Field("Scale", t.localScale);
    ...
    private Vector3 Vector3Field(string str,Vector3 vector)
    {
        Vector3 result = vector;
        EditorGUILayout.BeginHorizontal();
        EditorGUILayout.LabelField(str);
        EditorGUILayout.LabelField("X", GUILayout.Width(8));
        result.x = EditorGUILayout.FloatField(result.x);
        EditorGUILayout.LabelField("Y", GUILayout.Width(8));
        result.y = EditorGUILayout.FloatField(result.y);
        EditorGUILayout.LabelField("Z", GUILayout.Width(8));
        result.z = EditorGUILayout.FloatField(result.z);
