...
public class InitData : MonoBehaviour
{
    ...
    void MagicPartInit()
    {
        ...
        Reaction reaction = new Reaction_Affect(new extraAttackUp(1), ReactionKind.Reaction_Affect_DamageUp);
        ...
        a[4] = 0;
        reaction = new Reaction_Affect(new extraDeffenceUp(1), ReactionKind.Reaction_Affect_DamageUp);
